      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              AI-driven Roblox game development. From idea to playable game in minutes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              ...
              <li><span className="text-gray-300">Templates (soon)</span></li>
              <li><span className="text-gray-300">Plugin (soon)</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              <li><span className="text-gray-300">Documentation (soon)</span></li>
              <li><a href="#faq" className="hover:text-primary-600 transition-colors">FAQ</a></li>
              <li><span className="text-gray-300">Blog (soon)</span></li>
              <li><span className="text-gray-300">Changelog (soon)</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500">
              <li><span className="text-gray-300">Privacy Policy (soon)</span></li>
              <li><span className="text-gray-300">Terms of Service (soon)</span></li>
              <li><span className="text-gray-300">Contact (soon)</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} RoFlow. All rights reserved.
          </p>
